...
options(width = 100)
library(knitr)
opts_chunk$set(message = F, error = F, warning = F, comment = NA, fig.align = 'center', cache=TRUE, dpi = 100, tidy = F, cache.path = '.cache/', fig.path = 'E:/Conrad_github/courses/08_PracticalMachineLearning/021randomForests/fig/')
...
```{r forestIris, dependson="iris",fig.height=4,fig.width=4,cache=TRUE}
library(caret); 
