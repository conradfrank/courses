...
options(width = 100)
library(knitr)
opts_chunk$set(message = F, error = F, warning = F, comment = NA, fig.align = 'center', dpi = 100, tidy = F, cache.path = '.cache/', fig.path = 'E:/Conrad_github/courses/08_PracticalMachineLearning/020bagging/fig/')
